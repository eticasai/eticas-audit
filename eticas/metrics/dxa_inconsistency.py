...
class Dxa_inconsistency(BaseFairnessMetric):
    ...
    This means that the sensitive attribute (i.e. gender) can be inferred from the other attributes, which means that there are proxies in the model.
    """

    def compute(self, input_data, sensitive_attrs=None, input_features = None):
        """
        Parameters
        ----------
